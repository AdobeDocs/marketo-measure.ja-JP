---
description: Marketo Measure ユーザー向けマーケティングチャネルコストのガイダンス
...
[手順に直接移動するには、ここをクリックします。](/help/marketing-channel-costs.md)
...
直接広告接続からレポートおよびインポートされたコストは、最も詳細なレベルで自動的に取り込まれ、アップロードする必要はありません。 これには、現在のGoogle AdWords、Bing Ads、Doubleclick、Facebook との統合が含まれます。

[FAQ に直接移動するには、ここをクリックしてください。](/help/marketing-channel-costs.md)
...
マーケティングチャネルとルールを設定または更新すると、関連コストをアップロードできるようになります。 これを行うには、以下の手順に従います。
...
![[ マイアカウント ] メニューに移動し、[ 設定 ] をクリックします。](assets/spend-management-4.png)

**手順 2：現在のコストの CSV をダウンロード**

画面の右側に移動して、「**[!UICONTROL 現在のコストをダウンロード &#x200B;]」をクリックします。** このオプションを使用すると、スプレッドシートを CSV 形式でダウンロードできます。

![&#x200B; 画面の右側に移動して、「現在のファイルをダウンロード」をクリックします &#x200B;](assets/spend-management-1.png)
...
シートの論理ルールを確認します。 各行には、チャネルと、末尾に（.）ドットで区切られたサブチャネルの 1 つが含まれている必要があります。 この形式を一貫して使用することが重要です。
...
![&#x200B; 例えば、Facebook をサブチャネルとして、ソーシャルをサブチャネルとして示す &#x200B;](assets/spend-management-2.png)
...
**[!UICONTROL アプリの「]** Cost[!DNL Marketo Measure]」セクションに移動し、「**[!UICONTROL Upload.CSV]**」をクリックします。 システムが更新され、新しい情報が反映されます。
