---
description: 合計および起因する売上高と契約数の推移を示す収益概要ダッシュボードの概要
title: 収益の概要ダッシュボード
feature: Reporting
...
![ 昨年第 3 四半期のアトリビューション付き売上高はどのように積み上げられていますか ](assets/revenue-dashboard-1.png)
...
![ マーケティング活動による売上収益の割合はどれくらいでした ](assets/revenue-dashboard-2.png)。
