...
CallTrackingMetrics は、これを機能させるために、開発作業を行う必要があります。 サイトにJavaScriptを配置すると、CallTrackingMetrics は [!DNL Marketo Measure] Cookie から `_biz_uid` を取得できます。 この「BizibleId」は、CallTrackingMetrics によって保存されます。
