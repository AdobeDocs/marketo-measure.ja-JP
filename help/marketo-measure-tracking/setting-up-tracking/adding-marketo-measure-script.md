...
description: ' [!DNL Marketo Measure]  スクリプト - [!DNL Marketo Measure]を追加'
...
>[!TIP]
>
>スクリプトが[GDPRに準拠していることを確認する方法を説明します](/help/security-and-compliance/compliance-related-resources/ensuring-consent-for-gdpr-in-marketo-measure-js.md){target="_blank"}。
...
* 解決策：キャッシュされたデータに基づいてユーザーを[!DNL Marketo Measure]に報告し、放棄の慣行について話し合うために、いずれかのフォームを強制する必要があります。 一般に、[レポートユーザーコード](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/ajax-form-handling.md){target="_blank"}でこれを解決できます。
