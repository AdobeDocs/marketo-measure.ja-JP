...
description: ' [!DNL Pardot] - [!DNL Marketo Measure] への  [!DNL Marketo Measure] JavaScriptの追加'
title: ' [!DNL Pardot] に  [!DNL Marketo Measure] JavaScriptを追加しています'
...
# [!DNL Pardot] への [!DNL Marketo Measure] JavaScriptの追加 {#adding-marketo-measure-javascript-to-pardot}
...
1. HTMLページの閉じるヘッダータグの直前に [!DNL Marketo Measure] JavaScript コードをコピー&amp;ペーストします。
...
[!DNL Pardot] IFrame に次のHTMLタグがある場合：
