---
description: 各販売ステージの時間を追跡し、チャネルごとのトレンドの推移を比較するための商談速度ダッシュボードを表します
title: 商談速度ダッシュボード
feature: Reporting
...
![ 「商談作成」の前のステージは、最新のタッチポイント日を ](assets/lead-dashboard-1.png) のように使用します
...
![ セールス全体を通じてオポチュニティが最も速く進行した月 ](assets/lead-dashboard-2.png)
...
![ 「見込み客」ステージの商談速度は、様々なところで ](assets/lead-dashboard-3.png) のように異なります？
