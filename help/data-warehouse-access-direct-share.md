---
description: SnowflakeのMarketo Measure Data Warehouse への直接共有アクセスを有効にするための要件と手順について説明します
...
![Marketo Measure アプリで「設定」セクションを開き、](assets/data-share-1.png) に移動します。
