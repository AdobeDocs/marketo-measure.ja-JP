---
description: ダッシュボードの基本を見る –  [!DNL Marketo Measure]  – 製品
...
<table style="table-layout:auto"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>フィルターペインを開くか閉じるかを切り替えます。
   <p><img src="assets/discover-dashboard-basics-1.png"></td>
  </tr>
  <tr> 
   <td><b>検索バー</b></td>
   <td>フィルターパネルの上部にある検索を使用して、特定のフィルターを検索します。 各フィルターには、独自の検索バーもあります。
  ...
  <tr> 
   <td><b>「適用」ボタン</b></td>
   <td>クリックして、ダッシュボードでフィルターの変更を確認し、実装します。
