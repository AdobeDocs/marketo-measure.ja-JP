...
![ 訪問、訪問者、フォーム送信の web トラフィックの推移グラフ ](assets/web-traffic-dashboard-1.png)
...
![ ページタイトルと URL 別の web トラフィック概要テーブル ](assets/web-traffic-dashboard-2.png)
...
![ 訪問回数とユニーク訪問者数を表示するリファラーテーブル ](assets/web-traffic-dashboard-3.png)
...
![ チャネル別の訪問回数とユニーク訪問者数の棒グラフ ](assets/web-traffic-dashboard-4.png)
