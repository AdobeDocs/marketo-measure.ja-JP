...
![&#x200B; コスト、起因する収益および ROI の ROI ダッシュボード KPI タイル &#x200B;](assets/roi-dashboard-1.png)
...
![&#x200B; チャネル別積み重ね棒グラフのコストと収益 &#x200B;](assets/roi-dashboard-2.png)
...
![&#x200B; 実現済みとシンプルな ROI トレンドの折れ線グラフ &#x200B;](assets/roi-dashboard-3.png)
...
![&#x200B; ドリルコントロール付きコストの経時的な積み重ね棒グラフ &#x200B;](assets/roi-dashboard-4.png)
...
![&#x200B; チャネル別マーケティング費用の棒グラフ &#x200B;](assets/roi-dashboard-5.png)
