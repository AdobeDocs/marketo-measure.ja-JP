...
* ドリルダウン：時間、分、時間別に作成日を参照

-Web サイト：アカウントの「Web サイト」フィールドにある値

 — エンゲージメント評価：予測エンゲージメントスコア (PES) は [!DNL Marketo Measure]^1
...
* ドリルダウン：アカウントにマッピングされたリードの詳細を表示

 — 属性タッチポイント：アカウントの購入者属性タッチポイント数

* ドリルダウン：購入者属性タッチポイントの詳細（ID、E メール、タッチポイントの日付、アカウント名、キャンペーン、チャネル、サブチャネル、マーケティングタッチタイプ、アトリビューションモデル）を参照してください。
...
指定した商談に関連する次のデータを表示します。

 — 商談 ID:CRM のオポチュニティ ID

 — 商談名：CRM の商談名

 — アカウント名：オポチュニティに関連付けられたアカウント名
...
ドリルダウン：時間、分、時間別のクローズ日を参照

 — 金額：商談の合計金額

 — 連絡先：オポチュニティに関連付けられた連絡先の数
...
* ドリルダウン：時間、分、時間別に作成日を参照
 ...
 — 属性タッチポイント：連絡先の購入者属性タッチポイント数

* ドリルダウン：購入者属性タッチポイントの詳細（ID、E メール、タッチポイントの日付、アカウント名、キャンペーン、チャネル、サブチャネル、マーケティングタッチタイプ、アトリビューションモデル）を参照してください。

 — タッチポイント：連絡先の購入者タッチポイントの数

* ドリルダウン：アカウントの連絡先タッチポイントの詳細（ID、E メール、タッチポイントの日付、アカウント名、キャンペーン、チャネル、サブチャネル、マーケティングタッチタイプ）を参照してください。
...
指定したキャンペーンに関連する次のデータを表示します。
 ...
 — 属性モデル：選択したモデルに基づく適切なアトリビューションが表示されます
