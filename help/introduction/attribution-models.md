---
description: Marketo Measure アトリビューションモデル
...
![&#x200B; ファーストタッチ、リード作成、商談作成、受注案件の 4 つのマイルストーンタッチポイントを示すカスタマージャーニータイムライン &#x200B;](assets/1-1.png)
...
![Adwords チャネルに対するアトリビューションクレジットが 100% であることを示すファーストタッチモデル図 &#x200B;](assets/2.png)
...
![LinkedIn チャネルに対するアトリビューションクレジットが 100% であることを示すリード作成モデル図 &#x200B;](assets/3.png)
...
![Adwords にクレジットの 50%、LinkedIn にクレジットの 50% を示す U字型モデル図 &#x200B;](assets/4.png)
...
![W字型モデル図で、FT、LC、OC タッチポイントごとに 30% のクレジットを示し、中間タッチポイントに 10% のクレジットを示す &#x200B;](assets/5.png)
...
![&#x200B; フルパスモデル図で、FT、LC、OC、CW タッチポイントそれぞれに対して 22.5% のクレジットを示し、中間タッチポイントに対して 10% のクレジットを示している &#x200B;](assets/6.png)
