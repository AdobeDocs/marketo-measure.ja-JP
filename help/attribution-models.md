...
![契約成立（CW） ](assets/overview-resources-8.png)
...
![ ケイトがAdwords Ad](assets/overview-resources-9.png)経由で初めてwww.adobe.comを訪問しました
...
![Kateが](assets/overview-resources-10.png)経由でwww.adobe.comに初めてアクセスした後、前の例から続きます
...
![KateがAdwords広告を通じて最初にwww.adobe.comにアクセスすると、50%](assets/overview-resources-11.png)が表示されます
...
![Hillaryは価格ページへのリンクが記載されたメールを受信し、](assets/overview-resources-12.png)
...
![商談創出後、Kate、Austin、HillaryがMarketoへの提案を決定](assets/overview-resources-13.png)
