...
![ 追跡されたセッションの数を示すインサイトセッションリスト ](assets/1.png)
...
![ セッション内のページビューを表示するセッションの詳細パネル ](assets/4.png)
