---
description: Adobe Admin Console プロファイルを使用したMarketo Measure アクセスの設定とログインのガイド
...
![Adobe Admin Consoleにアクセスすると、Marketo Measure](assets/adobe-setup-1.png)が表示されます
...
![Marketo Measure Product Cardをクリックすると、すべての](assets/adobe-setup-2.png)が表示されます
