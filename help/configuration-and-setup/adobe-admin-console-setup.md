---
description: Adobe Admin Console プロファイルとログインを通じてMarketo Measureへのアクセスを設定するガイド
...
![Adobe Admin Consoleにアクセスすると、Marketo Measureが表示されます ](assets/adobe-setup-1.png)
...
![Marketo Measure製品カードをクリックすると、製品カード内の ](assets/adobe-setup-2.png)
...
>[!NOTE]
>
>[!DNL Marketo Measure] 管理者（[experience.adobe.com/marketo-measure](https://experience.adobe.com/marketo-measure?lang=ja){target="_blank"}）になるには、[!DNL Marketo Measure] 製品カード内のすべての [!DNL Marketo Measure] 製品プロファイルで、ユーザー _および_ 管理者）として追加される必要があります。

**[!DNL Marketo Measure]** へのログイン

製品プロファイルに追加されたユーザーは、[experience.adobe.com/marketo-measure](https://experience.adobe.com/marketo-measure?lang=ja){target="_blank"} で「**Adobe IDでログイン**」オプションを選択することで、[!DNL Marketo Measure] インスタンスにアクセスできます。

![ 製品プロファイルに追加されたユーザーは、次のことが可能です ](assets/adobe-setup-3.png)
