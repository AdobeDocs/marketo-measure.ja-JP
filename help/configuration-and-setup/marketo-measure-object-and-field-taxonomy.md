...
![ 以下は、Marketo Measureのカスタム方法を表すフローチャートです ](assets/bizible-full-1.png)

フルサイズの画像については、[ ここをクリック ](assets/bizible-full-1.png) してください。
...
これは、[!DNL Marketo Measure] のカスタム [!DNL Salesforce] オブジェクトで、購入者タッチポイントをリードおよび連絡先にリンクします。
...
これは、[!DNL Marketo Measure] アプリに存在するカスタムマーケティングチャネルダッシュボードです。 [!DNL Marketo Measure] の「[!DNL Salesforce]」タブに移動してアクセスできます。
