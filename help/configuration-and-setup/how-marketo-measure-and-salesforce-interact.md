---
description: 書き出し権限やバッチ設定など、Marketo MeasureとSalesforceのデータ交換方法の概要
...
![Marketo Measure Salesforce パッケージをインストールしていない場合 &#x200B;](assets/bizible-full-1.png)
...
![&#x200B; デフォルトでは、Marketo Measureは、各 API クレジットあたり 200 レコードを書き出します &#x200B;](assets/bizible-taxonomy-1.png)
