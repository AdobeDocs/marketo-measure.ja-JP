...
1. Marketo プログラムでルールの設定を開始するには、**[!UICONTROL マイアカウント]**/**[!UICONTROL 設定]**/**[!UICONTROL プログラム]** に移動します。 **+** アイコンをクリックして、最初のルールの作成を開始します。
   ...
   ![1.Marketo プログラムでルールの設定を開始するには、](assets/marketo-engage-programs-01.png) の場所に移動します。

   ![1.Marketo プログラムでルールの設定を開始するには、](assets/marketo-engage-programs-06.png) の場所に移動します。
...
1. ルールの追跡に役立つ場合は、オプションでルールの名前を設定できます。 最初にフィールドを選択して、プログラムおよびプログラムメンバーシップフィールドのリストからルールを定義します。 演算子とチェックする期待値を選択して、ルールの作成を続けます。
   ...
   ![1.](assets/marketo-engage-programs-07.png) の場合は、オプションでルールの名前を設定できます。

1. 同じボックス内に別のステートメントを追加してルール内の「and」条件を設定するか、ボックスの外側の「+」アイコンをクリックして「or」ステートメントを設定します。

   ![1.同じボックス内に別のステートメントを追加して、](assets/bizible-discover-1.png) のステートメントを設定します。

1. タッチポイントの日付にマッピングするために使用する日付または日付/時間フィールドを選択します。 Marketoで使用可能な値のリストを表示するには、中括弧 `{` を入力してください。使用可能なフィールドが表示されます。

   ![1.マッピングに使用する日付または日付/時間フィールドを選択 &#x200B;](assets/marketo-engage-programs-02.png)
   ...
   ![&#x200B; ルールでアクティビティ日または日付を取り込む場合 &#x200B;](assets/bizible-discover-2.png)
...
1. テストを実行するには、次に示すように、「**[!UICONTROL テスト]**」ボタンをクリックします。
   ...
   ![1.テストを実行するには、](assets/marketo-engage-programs-03.png) に示すように [TEST] ボタンをクリックします。

1. モーダルが表示され、Marketoからプログラム ID を入力できます。

   ![1.プログラムに入力できるモーダルが表示されます &#x200B;](assets/marketo-engage-programs-04.png)
   ...
   ![&#x200B; ルールは、サンプルサイズ 5,000 メンバーで実行されます。 あなたの場合 &#x200B;](assets/marketo-engage-programs-05.png)

   「メンバー数」をクリックして、プログラム内で適格なMarketoの人物 ID のリストを表示できます。

   ![&#x200B; メンバー数をクリックすると、Marketoのリストを表示できます &#x200B;](assets/marketo-engage-activities-08.png)
...
1. まず、値にマッピングするチャネルを選択してから、オプションでサブチャネルを選択します。 完了したら、下部にある **[!UICONTROL 保存]** をクリックします。
   ...
   ![1.最初に値にマッピングするチャネルを選択し、](assets/marketo-engage-programs-08.png) の操作を実行します。
