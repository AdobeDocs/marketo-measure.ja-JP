...
![Opportunity への時系列の進行を示す、MQL および SQL のブーメランタッチポイントを示すリードジャーニー図 &#x200B;](assets/1-1.png)
...
![&#x200B; カスタムステージとして追跡される MQL および SAL を使用した SQL ブーメランタッチポイントを示すリードジャーニー &#x200B;](assets/2-1.png)
...
![&#x200B; 同じタッチポイントで組み合わされた SAL 位置と OC 位置を持つ、スキップされた SAL ステージを示すリードジャーニー &#x200B;](assets/3.png)
...
![MQL および SAL ブーメランタッチポイントが Opportunity に変換されていることを示す 3 つのリードジャーニー図 &#x200B;](assets/4.png)
...
**シナリオ 2 - [!UICONTROL &#x200B; オポチュニティを持つ 3 人のリード]**
...
![Opportunity での位置番号を使用した、MQL、SQL、SAL のブーメランタッチポイントを示す 3 つのリードジャーニー &#x200B;](assets/5.png)
...
このオポチュニティに含まれる SAL タッチポイントは 2 つだけです。 ステージトランジションのタッチポイントが発生していない場合、[!DNL Marketo Measure] は強制/作成を試みません。
...
![SQL ステージ後に発生した場合に、オポチュニティから除外された Web 訪問ブーメランタッチポイントを示す 3 つのリードジャーニー &#x200B;](assets/6.png)
...
![&#x200B; 複数のステージトランジションでブーメランアトリビューションの重み付けを示す 3 つのリードジャーニー &#x200B;](assets/7.png)
...
![&#x200B; 商談に関する OC タッチポイントの後に表示されるデモおよび交渉ブーメランタッチポイントを示す連絡先ジャーニー &#x200B;](assets/8.png)
