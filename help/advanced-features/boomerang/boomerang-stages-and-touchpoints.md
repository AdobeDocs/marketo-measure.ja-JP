...
>[!NOTE]
>[ ブーメランステージの設定方法の説明 ](/help/advanced-features/boomerang/setting-up-boomerang-stages.md)
...
![ ブーメランを使用しない最新のステージタッチポイントのみを示す商談レコード ](assets/1.png)
...
![ 複数の MQL および SQL ステージ遷移に対して表示されるブーメランタッチポイント ](assets/2.png)
