...
>[!MORELIKETHIS]
> [&#x200B; タッチポイントの削除と抑制の概要 &#x200B;](/help/advanced-features/touchpoint-settings/touchpoint-removal-and-touchpoint-suppression.md)
> [タッチポイントを削除すべきでない理由 &#x200B;](/help/advanced-features/touchpoint-settings/why-you-should-never-delete-touchpoints.md)
> [バイヤー属性タッチポイント（BT）とバイヤー属性タッチポイント（BAT）の比較 &#x200B;](/help/configuration-and-setup/getting-started-with-marketo-measure/touchpoint-differences.md)
