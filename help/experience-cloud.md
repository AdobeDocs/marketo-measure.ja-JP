---
description: Marketo Measure ユーザー向けのAdobe Experience Cloud インターフェイスの概要ガイダンス
...
[!DNL Marketo Measure] ーザーのサポートを受けずに [&#x200B; ドメイン  [!DNL Marketo Measure]  管理 &#x200B;](/help/domain-management.md) します。
...
言語やその他のAdobe全体の環境設定を変更するには、自分のプロファイルアイコンをクリックします。 また、&lbrack; マイ設定 **をクリックして、[!DNL Marketo Measure] 固有の変更を行うこ** もできます。
