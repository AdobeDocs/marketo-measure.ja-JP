...
![Marketo Measure Discoverでリード（人物）をレポートする場合、](assets/bizible-discover-1.png) のようになります。

![Marketo Measure Discoverでリード（人物）をレポートする場合、](assets/bizible-discover-2.png) のようになります。
