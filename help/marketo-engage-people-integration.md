...
![これらの重複を検出するには、](assets/marketo-engage-programs-06.png)を確認してください

![これらの重複を検出するには、](assets/marketo-engage-programs-07.png)を確認してください
...
![Marketo Measure Discoverでリード（人物）についてレポートする場合、次の操作を行います](assets/bizible-discover-1.png)

![Marketo Measure Discoverでリード（人物）についてレポートする場合、次の操作を行います](assets/bizible-discover-2.png)
