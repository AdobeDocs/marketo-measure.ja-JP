---
description: リードの連絡先と商談が段階的にどのように移動するかを追跡する Passport ダッシュボードについて説明します
title: パスポートダッシュボード
feature: Reporting
...
![&#x200B; 開始日と終了日は両方とも含まれます。](assets/passport-dashboard-1.png)
...
![&#x200B; 開始日と終了日は両方とも含まれます。](assets/passport-dashboard-2.png)
