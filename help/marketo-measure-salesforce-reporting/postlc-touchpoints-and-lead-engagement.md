---
description: リードおよび連絡先に対して更新され制限されている PostLC タッチポイントを作成する方法を説明します
...
![Marketo Measure リード後の作成（PostLC）タッチポイントは、](assets/additional-functionality-1.png) の製品を使用しているお客様が利用できます。
