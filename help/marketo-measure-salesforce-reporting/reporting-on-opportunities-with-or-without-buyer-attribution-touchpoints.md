---
description: Marketo Measure ユーザー向けの、買い手属性タッチポイントガイダンスの有無に関する商談レポート
...
1. **[!UICONTROL 設定]**/**[!UICONTROL 作成]**/**[!UICONTROL レポートタイプ]** に移動します。
   ...
   ![1.設定レポートタイプを作成に移動します。](assets/bizible-guide-1.png)

1. **[!UICONTROL 新規カスタムレポートタイプ]** を選択します。

   ![1.新規カスタムレポートタイプを選択。](assets/bizible-guide-2.png)
