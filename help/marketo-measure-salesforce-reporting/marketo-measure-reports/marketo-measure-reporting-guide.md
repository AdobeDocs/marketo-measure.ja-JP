...
>[!NOTE]
>
>BAT は BT から作成されます。 基本的に、追跡は BT を介して個人レベルで開始されます。 アカウントで商談を作成すると、同じアカウントの連絡先の BT が参照され、商談に関連する BAT を作成する資格が与えられます。「人」指標（BT レポート）に関する質問、「商談」指標（BAT レポート）に関する質問
