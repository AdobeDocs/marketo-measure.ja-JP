...
* [Marketo Measure Script の追加](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script.md)
* [購入者タッチポイントと購入者属性タッチポイントの違い](/help/configuration-and-setup/getting-started-with-marketo-measure/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md)
* [オンラインカスタムチャネルのセットアップ](/help/channel-tracking-and-setup/online-channels/online-custom-channel-setup.md)
