---
description: Marketo Measure ユーザー向け Dynamics キャンペーンおよびマーケティングリストのガイダンス
...
![ リードまたは連絡先がキャンペーンに直接追加されると、そのリードまたは連絡先が入力されます ](assets/dynamics-lists-1.png)
...
![ これらのレコードをタッチポイントジャーニーに含めるには、](assets/dynamics-lists-10.png) 下の操作を行います。
...
![Marketo Measureは、カスタムの応答値をサポートしていません。](assets/dynamics-lists-2.png)

キャンペーン応答の在庫応答値は次のとおりです。

![ キャンペーン応答の在庫応答値は次のとおりです。](assets/dynamics-lists-3.png)
...
![ このフィールドを使用する一般的な例の 1 つは、リストを使用するイベントの場合です ](assets/dynamics-lists-4.png)
...
![Marketo Measureでは、静的マーケティングリストのみをサポートしています。 サポートしていません ](assets/dynamics-lists-5.png)
...
![ タッチポイントのマーケティングリストを有効にするには、別の設定があります ](assets/legacy-processes-10.png)
...
![ マーケティングリストのタッチポイント日は、通常、作成された ListMember です ](assets/dynamics-lists-6.png)
...
![ キャンペーンタイプごとに、チャネルにマッピングできます。](assets/dynamics-lists-7.png)

![ キャンペーンタイプごとに、チャネルにマッピングできます。](assets/dynamics-lists-8.png)
