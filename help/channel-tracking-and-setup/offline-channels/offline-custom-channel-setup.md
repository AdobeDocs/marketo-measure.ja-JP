...
![Salesforce Campaign のタイプ、チャネル、サブチャネルの 3 つの列を表示するスプレッドシートテンプレート ](assets/1-2.png)
...
![Salesforce キャンペーンタイプ リストを表示する「オフラインチャネル」タブ ](assets/2-2.png)
...
![ 新しいチャネルとサブチャネルを作成するためのインターフェイスを示す「チャネルを作成」セクション ](assets/3-2.png)
...
![ 異なるサブチャネルにマッピングされた同じキャンペーンタイプを示す誤ったチャネルマッピング ](assets/4-2.png)

上記のシナリオでは、同じキャンペーンタイプを 2 つの異なるサブチャネルにマッピングできないので、一意のキャンペーンタイプを作成する必要があります。 代わりに、次のような一意のタイプを設定する必要があります。

![ 様々なサブチャネルの一意のキャンペーンタイプを示す正しいチャネルマッピング ](assets/5-2.png)
...
![ オンラインキャンペーンに対して NULL チャネルの作成を示す「チャネルを作成」セクション ](assets/6-2.png)
...
![ チャネルマッピングルールを入力するための選択リストボックスを備えたオフラインチャネルインターフェイス ](assets/7-2.png)
...
> [Marketo Engage プログラム ](/help/marketo-measure-and-marketo/marketo-engage-programs-integration.md#channel-mapping){target="_blank"} 統合
