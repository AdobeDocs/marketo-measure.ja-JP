...
![&#x200B; 履歴データのSalesforce キャンペーン同期ルールの例 &#x200B;](assets/syncing-historical-data-1.png)
...
![&#x200B; 「Buyer Touchpoint日」フィールドを使用した Dynamics マーケティングリストの設定 &#x200B;](assets/syncing-historical-data-2.png)
