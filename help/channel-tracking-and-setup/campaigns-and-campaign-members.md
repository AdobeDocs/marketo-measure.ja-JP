---
description: Marketo Measure ユーザー向けのキャンペーンとキャンペーンメンバーのガイダンス
...
![Marketo Measure Salesforce パッケージには、](assets/dynamics-lists-1.png)というラベル付きのフィールドが含まれます
...
![Marketo Measureを使用する前に、マーケティングオートメーションプラットフォームを使用した場合](assets/dynamics-lists-2.png)
...
![有効にすると、Marketo Measureはステータス値を](assets/dynamics-lists-3.png)にプッシュします
...
![一括更新タッチポイント日は、インストール済みのMarketo](assets/dynamics-lists-5.png)に含まれています
...
![機能しない検索が1つあります。これは](assets/legacy-processes-10.png)に表示されます
...
![日付と時刻を設定したら、「選択した項目を更新」をクリックします](assets/dynamics-lists-6.png)
