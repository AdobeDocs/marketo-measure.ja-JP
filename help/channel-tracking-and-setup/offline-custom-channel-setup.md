---
description: Marketo Measure ユーザー向けのオフラインカスタムチャネル設定ガイダンス
...
![SFDC キャンペーンの種類は、リストされているオフラインチャネルのタブに表示されます](assets/offline-channels-10.jpg)
...
![ここでは、](assets/offline-channels-11.png)でチャネル/サブチャネルマッピングを作成できます
...
![以下は、Marketo Measureが実行しないロジックの例です](assets/offline-channels-12.png)
...
>
>* [Marketo Engage プログラム統合](/help/marketo-engage-programs-integration.md){target="_blank"}
