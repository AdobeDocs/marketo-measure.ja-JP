---
description: Marketo Measure ユーザー向けのオンラインチャネルガイダンスのベストプラクティス
...
オンラインチャネルルールは、保存および処理した後、デジタルタッチポイントをバケット化するために引き続き機能します。 ただし、一部の変更やシナリオでは、オンラインチャネルの設定を確認する必要が生じます。[!DNL Marketo Measure] では、6 か月に 1 回オンラインチャネルのルールを確認することをお勧めします。 これにより、[!DNL Marketo Measure] データがオンラインチャネル／サブチャネルの内部定義および UTM の使用状況と一致します。
