---
description: Marketo Measure ユーザー向けのブーメランステージとタッチポイントのガイダンス
...
>[!NOTE]
>
>[ ブーメランステージの設定方法の説明 ](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md)
...
![ ブーメランステージ（「前」）を使用しない場合、表示されるのは最新の MQL のみです ](assets/boomerang-stages-18.png)
...
![ 次の例では、このMarketo Measure アカウントに MQL が含まれています ](assets/boomerang-stages-19.png)
