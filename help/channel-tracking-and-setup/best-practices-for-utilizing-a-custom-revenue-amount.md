---
description: Marketo Measure ユーザー向けのカスタム収益額ガイダンスの利用に関するベストプラクティス
...
実装時に特に指定しない限り、[!DNL Marketo Measure] インスタンスは、売上高アトリビューションの標準的な商談額（SFDCのデフォルト）を参照するように設定されます。 ただし、多くの [!DNL Marketo Measure] アカウントでは、このフィールドには商談の正確な収益額が反映されません。 このような場合、[!DNL Marketo Measure] では、アトリビューションタッチポイント（BAT）全体で参照および配布する [!DNL Marketo Measure] のカスタム収益額を設定する機能を提供します。
...
>[!MORELIKETHIS]
>
>* [ カスタムの「売上高」フィールドの使用 ](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
...
>* [ 多通貨の概要 ](/help/channel-tracking-and-setup/overview.md)
>* [ 複数通貨設定 ](/help/channel-tracking-and-setup/settings.md)
