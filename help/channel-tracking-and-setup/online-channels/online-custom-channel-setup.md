...
![&#x200B; 「元のテンプレートをダウンロード」および「現在のルールをダウンロード」オプションを使用したオンラインチャネル設定を示す設定ページ &#x200B;](assets/1.png)

スプレッドシートには、次の 7 つの列があります。

![Channel、Subchannel、Campaign、Medium、Source、ランディングページおよび参照元 web サイトの 7 つの列を表示するカスタムチャネルスプレッドシート &#x200B;](assets/2.png)
...
![Social.Facebook ルールの例が強調表示されたトップダウンの優先順を示すチャネルルールスプレッドシート &#x200B;](assets/3.png)
...
![&#x200B; カスタマイズ可能なチャネル名とサブチャネル名を持つ 12 の統合プラットフォームを示すデフォルトのチャネルルール &#x200B;](assets/4.png)
...
![&#x200B; サブチャネルにマッピングされた異なるパラメーターを持つ複数の行を示す Facebook チャネルルールの例 &#x200B;](assets/5.png)
...
![&#x200B; 一致しないデータに対するキャッチオール バケットとしてワイルドカードアスタリスクを表示するその他のチャネルルール &#x200B;](assets/6.png)
