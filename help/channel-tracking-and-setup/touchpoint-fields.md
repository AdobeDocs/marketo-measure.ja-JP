...
![{6} は抽出する文字数です &#x200B;](assets/touchpoint-fields-12.png)
...
![{6} は抽出する文字数です &#x200B;](assets/touchpoint-fields-13.png)
...
![10 を抽出するには、値を「BZ=\d{2}-\d{2}-\d{2}-\d{2} – （\d{2}）」として定義します &#x200B;](assets/touchpoint-fields-3.png)
