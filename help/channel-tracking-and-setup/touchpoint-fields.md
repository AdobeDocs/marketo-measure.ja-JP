---
description: Marketo Measure ユーザー向けタッチポイントフィールドガイダンス
...
![Marketo Measure設定メニューからタッチポイントフィールドに移動します &#x200B;](assets/touchpoint-fields-1.png)
...
![.&amp;42；は、文字列全体を抽出していることを示しています &#x200B;](assets/touchpoint-fields-10.png)
...
![&#x200B; スラッシュは使用していますが、は使用しないでください &#x200B;](assets/touchpoint-fields-11.png)
...
抽出する文字数は ![{6} のとおりです &#x200B;](assets/touchpoint-fields-12.png)
...
抽出する文字数は ![{6} のとおりです &#x200B;](assets/touchpoint-fields-13.png)
...
![&#x200B; 「夏の終わりのプロモーション」用に作成したキャンペーンがあります &#x200B;](assets/touchpoint-fields-2.png)
...
* 「04」の値を抽出するには、その値を「BZ=（\d{2}） – \d{2}-\d{2}-\d{2}-\d{2}」と定義します。
...
* 残りの 4 組の数字に対して、抽出とマッピングを繰り返します
   ...
   * 01 を抽出するには、値を「BZ=\d **-** （\d&#x200B;**） &#x200B;**-\d&#x200B;**-\d**-\d**」と定義します。
   * 09 を抽出するには、値を「BZ=\d **-\d**-**&#x200B; （\d**） **-\d**-\d**」と定義します。
   * 03 を抽出するには、値を「BZ=\d **-\d**-\d&#x200B;**-** （\d&#x200B;**） &#x200B;**-\d**」と定義します。
   * 10 を抽出するには、値を「BZ=\d **-\d**-\d&#x200B;**-\d**-**&#x200B; （\d**） **」と定義します。

![10 を抽出するには、値を「BZ=\d](assets/touchpoint-fields-3.png)-\d&rbrack;(assets/touchpoint-fields-3.png)-\d&rbrack;(assets/touchpoint-fields-3.png)-\d&rbrack;(assets/touchpoint-fields-3.png) – （\d&rbrack;(assets/touchpoint-fields-3.png)）」と定義します &rbrack;(assets/touchpoint-fields-3.png)
...
![Segmentc と Gradec の Opportunity オブジェクトには別々のフィールドがあります &#x200B;](assets/touchpoint-fields-4.png)
...
![&#x200B; タッチポイントフィールドを使用してセグメントを作成する機能は、これで利用できるようになりました &#x200B;](assets/touchpoint-fields-5.png)
...
![&#x200B; 設定は、次のスクリーンショットのようになります。 セグメント名 &#x200B;](assets/touchpoint-fields-6.png)

ルールが同じタッチポイントフィールドを参照し、「null に等しくない」値を検索します。

![&#x200B; ルールが同じタッチポイントフィールドを参照し、次の値を検索する &#x200B;](assets/touchpoint-fields-7.png)
...
![&#x200B; 実行およびテストできるオンラインツールがあります（https://regex101.com/(https://regex101.com/){target="blank"}） &#x200B;](assets/touchpoint-fields-8.png)

![&#x200B; 実行およびテストできるオンラインツールがあります（https://regex101.com/(https://regex101.com/){target="blank"}） &#x200B;](assets/touchpoint-fields-9.png)
