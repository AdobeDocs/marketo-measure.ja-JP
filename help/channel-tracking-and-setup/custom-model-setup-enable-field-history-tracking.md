...
カスタムフィールドをカスタムアトリビューションモデルのステージとして含めることを決定した場合は、このフィールドに対してフィールド履歴トラッキングを&#x200B;**有効にする必要**&#x200B;があります。 フィールド履歴トラッキングを有効にすると、履歴トラッキ [!DNL Salesforce] グテーブルでレコードを作成することで、カスタムフィールドが編集されるたびに追跡できます。[!DNL Marketo Measure] このテーブルをダウンロードし、この情報を使用して、「移行」が発生した日時を測定できます。 フィールド履歴トラッキングを有効にしないと、[!DNL Marketo Measure] はこのフィールドに関連する変更を追跡できません。
