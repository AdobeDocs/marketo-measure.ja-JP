...
![最初の手順は、](assets/online-channels-1.png)からカスタムチャネルスプレッドシートをダウンロードすることです

スプレッドシートには、次の 7 つの列があります。

![&#x200B; スプレッドシートには7つの列があります：](assets/online-channels-2.png)
...
![行はルールとMarketo Measure](assets/online-channels-3.png)の順序を表します
...
![Marketo Measureには、12のデフォルトチャネルが用意されています。 これらの](assets/online-channels-4.png)
...
![&#x200B; ルールの各パラメーターまたはコンポーネントは、](assets/online-channels-5.png)に個別にマッピングされます
...
![既定のチャネル「その他」が存在し、該当しないデータを取得します](assets/online-channels-6.jpg)
