---
description: Marketo Measure ユーザー向けの概要ガイダンス
title: 概要
...
| **企業通貨** | これらは、CRM で組織によってリストおよび宣言される様々な通貨で、すべてコンバージョン率を持ちます。[!DNL Marketo Measure] はこれらの値をインポートし、これらの通貨をアドビの製品内のユーザーが使用できるようにします。 |
