...
オフラインキャンペーンを正確にトラッキングし、デジタルマーケティング活動と比較して理解することは困難な場合があります。[!DNL Marketo Measure] を使用すると、イベントから数週間後までオフラインキャンペーンが作成されない場合でも、[!DNL Salesforce] でオフラインキャンペーンに対するタッチポイントを追跡し [!DNL Salesforce] 属性を付けることができます。
