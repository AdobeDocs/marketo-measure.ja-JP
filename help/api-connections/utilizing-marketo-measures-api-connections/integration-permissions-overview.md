...
<p>
  ...
  <tr>
    ...
    <td>お客様は、専用のMarketo Engage API ユーザーを作成し、Marketo Measureに資格情報を提供する必要があります。 追加の権限設定は必要ありません。 <a href="/help/marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/set-up-marketo-connection.md#configuring-the-integration">詳細情報</a>。</td>
  </tr>
  <tr>
