---
description: エンゲージメントダッシュボードで、タッチしたタッチポイントのトラッキングや、チャネル別のエンゲージメントの推移を確認します
...
* **購入者タッチポイント**：リードおよび連絡先属性に対して選択されたタッチポイント。 BT は商談にリンクされておらず、関連する売上高はありません。
* **バイヤー属性タッチポイント**：商談属性に対して選択されたタッチポイント。 BAT は商談にリンクされているため、収益に影響があります。
...
![1 人あたりのタッチポイントを 1 四半期/月から ](assets/engagement-dashboard-1.png) と比較する方法
...
![ 内でタッチされた人物と比較したタッチポイント数は ](assets/engagement-dashboard-2.png)
