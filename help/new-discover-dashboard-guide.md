---
description: 従来の Discover ダッシュボードを再設計されたバージョンにマッピングし、ナビゲーションと指標の主な変更点を強調します
title: Discover ダッシュボードガイド
feature: Reporting
...
# Discover ダッシュボードガイド {#new-discover-dashboard-guide}
...
新機能については、[&#x200B; ダッシュボードの基本を確認 &#x200B;](/help/discover-dashboard-basics.md){target="_blank"} の記事を参照してください。
