...
| 名前 | 説明 |
| --- | --- |
| フィルター切り替えボタン | フィルターウィンドウの表示/非表示を切り替えます。|||||||||||||||||||||||||![ — | — |] (apng) |
| 検索バー | フィルターウィンドウの上部にある検索を使用して、特定のフィルターを検索します。 各フィルターには独自の検索バーもあります。||||||||||||||||||||||||||![ — | — |] (apng) |
| フィルターボタンをクリア | フィルターをクリアするには、各フィルターの右上隅にある消しゴム アイコンをクリックします。||||||||||||||||||||||||||![ — | — |] (apng) |
| 「適用」ボタン | をクリックして、フィルターの変更を確認してダッシュボードに実装します。|||||||||||||||||||||![ — | — |] (apng) |
